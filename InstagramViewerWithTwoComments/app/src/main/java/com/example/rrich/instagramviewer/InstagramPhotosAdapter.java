...
public class InstagramPhotosAdapter extends ArrayAdapter<InstagramPhoto> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        TextView tvCommentUser1 = (TextView) convertView.findViewById(R.id.tvCommentUser1);
        TextView tvComment1 = (TextView) convertView.findViewById(R.id.tvComment1);
        TextView tvCommentUser2 = (TextView) convertView.findViewById(R.id.tvCommentUser2);
        TextView tvComment2 = (TextView) convertView.findViewById(R.id.tvComment2);
        ImageView commentLogo1 = (ImageView) convertView.findViewById(R.id.commentLogo1);
        ImageView commentLogo2 = (ImageView) convertView.findViewById(R.id.commentLogo2);
        ...
        if (photo.comment1 != null && photo.comment1 != "") {
            tvCommentUser1.setText(photo.commentUsername1);
            tvComment1.setText(photo.comment1);
            if (photo.comment2 != null && photo.comment2 != "") {
                tvCommentUser2.setText(photo.commentUsername2);
                tvComment2.setText(photo.comment2);
            } else {
                //Second most recent comment does not exist:
                commentLogo2.setVisibility(View.GONE);
                tvCommentUser2.setVisibility(View.GONE);
                tvComment2.setVisibility(View.GONE);
            }
        } else {
            // No comments exist:
            commentLogo1.setVisibility(View.GONE);
